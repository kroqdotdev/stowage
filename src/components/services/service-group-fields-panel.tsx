...
function mapFieldError(error: unknown, fallback: string) {
  ...
  if (code === "INVALID_FIELD_VALUE") {
    return getConvexUiErrorMessage(error, "One or more field values are invalid.");
  }
  if (code === "FORBIDDEN") {
    ...
    >
      ...
      >
        <div className="space-y-1.5">
          <label htmlFor="service-group-field-label" className="text-sm font-medium">
            Label
          </label>
          <Input
        ...
        <div className="space-y-1.5">
          <label htmlFor="service-group-field-type" className="text-sm font-medium">
            Type
          </label>
          <select
            ...
            value={fieldType}
            onChange={(event) => setFieldType(event.target.value as ServiceGroupFieldType)}
          >
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <label htmlFor="service-group-field-required" className="text-sm font-medium">
            Required
          </label>
        </div>
      </form>
    ...
    <>
      <section className="rounded-xl border border-border/70 bg-background p-5 shadow-sm">
        <div className="flex items-center justify-between gap-2">
          <div>
            <h3 className="text-sm font-semibold tracking-tight">Required record fields</h3>
              ...
              {rows === undefined ? (
                ...
                fields.map((field) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-2">
                      <Badge className="bg-muted/20 capitalize">{field.fieldType}</Badge>
                    </td>
                    <td className="px-3 py-2">
                      {field.required ? (
                      ...
                      {canManage ? (
                        <div className="inline-flex items-center gap-1">
                          ...
                          <Button
                            ...
                            onClick={() => setDeleteFieldId(field._id as string)}
