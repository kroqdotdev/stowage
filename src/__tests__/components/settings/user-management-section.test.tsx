...
describe("UserManagementSection", () => {
  ...
  it("blocks demoting the last admin and shows a toast", async () => {
    ...
    await user.selectOptions(screen.getByLabelText("Role for Alex Admin"), "user")
...
describe("SettingsPageClient", () => {
  ...
  it("shows reduced settings for non-admin users", () => {
    ...
    expect(screen.getByText("Only admins can create users or change roles.")).toBeInTheDocument()
