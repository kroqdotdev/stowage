...
describe("DynamicFieldDisplay", () => {
  it("renders text and number values", () => {
    ...
    rerender(
      <DynamicFieldDisplay definition={definition("number")} value={42} />,
    );
  ...
  it("renders booleans as Yes/No", () => {
    ...
    rerender(
      <DynamicFieldDisplay definition={definition("checkbox")} value={false} />,
    );
  ...
  it("formats currency values", () => {
    render(
      <DynamicFieldDisplay
        definition={definition("currency")}
        value={1234.5}
      />,
    );
  ...
  it("renders placeholder for null and undefined", () => {
    ...
    rerender(
      <DynamicFieldDisplay definition={definition("text")} value={undefined} />,
    );
    expect(screen.getByText("—")).toBeInTheDocument();
  });
});
