...
import type { AssetDetail as AssetDetailType, AssetStatus } from "@/components/assets/types"
...
export function AssetDetailPageClient({
  ...
  const loading = currentUser === undefined || asset === undefined || fieldDefinitions === undefined
