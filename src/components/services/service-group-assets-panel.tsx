...
export function ServiceGroupAssetsPanel({ groupId }: { groupId: Id<"serviceGroups"> }) {
  ...
  return (
    <section className="rounded-xl border border-border/70 bg-background p-5 shadow-sm">
      <div>
        <h3 className="text-sm font-semibold tracking-tight">Assigned assets</h3>
        <p className="text-xs text-muted-foreground">
          Assets assigned to this service group are maintained from asset create/edit.
        </p>
      </div>
