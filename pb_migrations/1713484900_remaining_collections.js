...
migrate(
  (app) => {
    ...
    users.fields.add(
      new NumberField({ name: "createdAt", required: true }),
    );
    users.fields.add(
    ...
    users.fields.add(
      new BoolField({ name: "isAnonymous", required: false }),
    );
    users.indexes = [
      ...users.indexes,
    ...
    const tags = new Collection({
      ...
      fields: [
        ...
        { name: "color", type: "text", required: true, pattern: "^#[0-9A-F]{6}$" },
    ...
    const appSettings = new Collection({
      ...
      fields: [
        ...
        { name: "updatedAt", type: "number", required: true },
        { name: "updatedBy", type: "relation", required: true, collectionId: usersId, maxSelect: 1, cascadeDelete: false },
      ],
      indexes: [
    ...
    const serviceGroupFields = new Collection({
      ...
      fields: [
        { name: "groupId", type: "relation", required: true, collectionId: serviceGroupsId, maxSelect: 1, cascadeDelete: true },
    ...
    const assets = new Collection({
      ...
      fields: [
        ...
        { name: "assetTag", type: "text", required: true, max: 50 },
        {
          ...
          required: true,
          maxSelect: 1,
          values: ["active", "in_storage", "under_repair", "retired", "disposed"],
        },
        { name: "categoryId", type: "relation", required: false, collectionId: categoriesCollection.id, maxSelect: 1, cascadeDelete: false },
        { name: "locationId", type: "relation", required: false, collectionId: locationsId, maxSelect: 1, cascadeDelete: false },
        { name: "serviceGroupId", type: "relation", required: false, collectionId: serviceGroupsId, maxSelect: 1, cascadeDelete: false },
    ...
    const assetTags = new Collection({
      ...
      name: "assetTags",
      fields: [
        { name: "assetId", type: "relation", required: true, collectionId: assetsId, maxSelect: 1, cascadeDelete: true },
        { name: "tagId", type: "relation", required: true, collectionId: tags.id, maxSelect: 1, cascadeDelete: true },
        { name: "createdBy", type: "relation", required: true, collectionId: usersId, maxSelect: 1, cascadeDelete: false },
        { name: "createdAt", type: "number", required: true },
      ],
      indexes: [
    ...
    const attachments = new Collection({
      ...
      fields: [
        { name: "assetId", type: "relation", required: true, collectionId: assetsId, maxSelect: 1, cascadeDelete: true },
        { name: "storageFile", type: "file", required: false, maxSelect: 1, maxSize: 26214400 },
        { name: "originalFile", type: "file", required: false, maxSelect: 1, maxSize: 26214400 },
    ...
    const serviceRecords = new Collection({
      ...
      fields: [
        { name: "assetId", type: "relation", required: true, collectionId: assetsId, maxSelect: 1, cascadeDelete: true },
        { name: "serviceGroupId", type: "relation", required: false, collectionId: serviceGroupsId, maxSelect: 1, cascadeDelete: false },
        { name: "serviceGroupNameSnapshot", type: "text", required: false, max: 200 },
        { name: "values", type: "json", required: false },
        { name: "fieldSnapshots", type: "json", required: false },
        { name: "scheduleId", type: "relation", required: false, collectionId: serviceSchedulesId, maxSelect: 1, cascadeDelete: false },
        ...
        { name: "providerId", type: "relation", required: false, collectionId: serviceProvidersId, maxSelect: 1, cascadeDelete: false },
        { name: "completedAt", type: "number", required: true },
        { name: "completedBy", type: "relation", required: true, collectionId: usersId, maxSelect: 1, cascadeDelete: false },
        { name: "createdAt", type: "number", required: true },
        { name: "updatedAt", type: "number", required: true },
      ],
      indexes: [
    ...
    const serviceRecordAttachments = new Collection({
      ...
      fields: [
        { name: "serviceRecordId", type: "relation", required: true, collectionId: serviceRecordsId, maxSelect: 1, cascadeDelete: true },
        { name: "storageFile", type: "file", required: false, maxSelect: 1, maxSize: 26214400 },
        { name: "fileName", type: "text", required: true, max: 500 },
        { name: "fileType", type: "text", required: true, max: 200 },
        { name: "fileExtension", type: "text", required: false, max: 20 },
