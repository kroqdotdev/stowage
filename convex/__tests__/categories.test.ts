...
describe("category helpers", () => {
  it("requires and normalizes category names", () => {
    ...
    expect(normalizeCatalogNameKey("  Laptop Computers  ")).toBe("laptop computers")
  ...
  it("normalizes optional prefix and description fields", () => {
    ...
    expect(normalizeOptionalText("  End user devices  ")).toBe("End user devices")
  ...
  it("normalizes hex colors to uppercase 6-digit values", () => {
    ...
    expect(() => normalizeHexColor("blue")).toThrowError("Enter a valid hex color")
  })
})
